...
module_dir = os.path.join(__location__, "../src/include")
...
try:
    from include import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'user_guide.tex', u'include Documentation',
